<template>
  <div class="app-container">
    <el-table :data="tableData" border>
      ...
      <el-table-column label="消费前余额" width="150">
        <template slot-scope="scope">
          <span>{{ scope.row.old_amount }}</span>
        </template>
      </el-table-column>

      <el-table-column label="消费后余额" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="消费金额" width="100">
        <template slot-scope="scope">
          <span>{{ scope.row.consume_amount }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="消费用户昵称" width="120">
        <template slot-scope="scope">
          <span>{{ scope.row.user.nickname }}</span>
        </template>
      </el-table-column>

      <el-table-column label="消费用户姓名" width="120">
        <template slot-scope="scope">
